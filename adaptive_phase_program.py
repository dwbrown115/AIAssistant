...
def build_default_kernel_phase_specs() -> tuple[AdaptivePhaseSpec, ...]:
    ...
    return (
        AdaptivePhaseSpec(
            ...
            module_id="learned_autonomy_controller",
            micro_stages=_micro(
                "p1",
                ...
                stage_labels=(
                    ...
                    "Bounded autonomy influence",
                ),
                stage_modes=("train", "train", "integrate", "control_integrate"),
                module_targets=("learned_autonomy_controller", "governance_orchestrator"),
                objective_signals=(
        ...
        AdaptivePhaseSpec(
            ...
            module_id="parallel_reasoning_engine",
            micro_stages=_micro(
                "p2",
                ...
                stage_labels=(
                    ...
                    "Confidence-gated control blend",
                ),
                stage_modes=("train", "train", "integrate", "control_integrate"),
                module_targets=("parallel_reasoning_engine", "governance_orchestrator"),
                objective_signals=(
        ...
        AdaptivePhaseSpec(
            ...
            micro_stages=_micro(
                ...
                stage_labels=(
                    ...
                    "Adaptive-first bounded control",
                ),
                stage_modes=("train", "train", "integrate", "control_integrate"),
                module_targets=("adaptive_controller", "parallel_reasoning_engine", "learned_autonomy_controller"),
                objective_signals=(
                    ("train_quality", "transfer", "introspection_gain"),
        ...
        AdaptivePhaseSpec(
            ...
            module_id="governance_orchestrator",
            micro_stages=_micro(
                "p4",
                ...
                stage_labels=(
                    ...
                    "Governed rollback control lane",
                ),
                stage_modes=("train", "train", "integrate", "control_integrate"),
                module_targets=("governance_orchestrator", "learned_autonomy_controller", "parallel_reasoning_engine"),
                objective_signals=(
        ...
        AdaptivePhaseSpec(
            ...
            micro_stages=_micro(
                ...
                stage_labels=(
                    ...
                    "Live control-path consolidation",
                ),
                stage_modes=("train", "train", "integrate", "control_integrate"),
                module_targets=("organism_control", "maze_agent", "governance_orchestrator"),
                objective_signals=(
                    ("train_quality", "stability", "safety"),
