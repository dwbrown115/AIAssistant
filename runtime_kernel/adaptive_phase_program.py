...
def build_default_kernel_phase_specs() -> tuple[AdaptivePhaseSpec, ...]:
    ...
    sr_forecast_module_targets = (
        "learned_autonomy_controller",
        "parallel_reasoning_engine",
        "governance_orchestrator",
    )
    sr3_exploration_module_targets = (
        "learned_autonomy_controller",
        "governance_orchestrator",
    )
    sr3_effort_module_targets = (
        "parallel_reasoning_engine",
        "governance_orchestrator",
    )
    sr3_safety_module_targets = (
        "organism_control",
        "maze_agent",
        "governance_orchestrator",
    )
    sr4_plasticity_module_targets = (
        "adaptive_controller",
        "learned_autonomy_controller",
        "parallel_reasoning_engine",
        "governance_orchestrator",
    )
    sr5_immune_module_targets = (
        "organism_control",
        "maze_agent",
        "parallel_reasoning_engine",
        "governance_orchestrator",
    )
    sr6_governance_module_targets = (
        "governance_orchestrator",
        "parallel_reasoning_engine",
        "learned_autonomy_controller",
        "adaptive_controller",
    ...
    return (
        AdaptivePhaseSpec(
            phase_id="phase_sr0_baseline_instrumentation_contract",
            label="Phase SR0 - Baseline + Instrumentation Contract",
            capability="freeze baseline envelope and enforce canonical self-regulation signal coverage",
            module_id="sr0_baseline_instrumentation_contract",
            micro_stages=(
                _stage(
        ...
        AdaptivePhaseSpec(
            phase_id="phase_sr1_homeostatic_core",
            label="Phase SR1 - Homeostatic Core",
            capability="stand up kernel-owned self-regulation state, update loop, and read-only regulator telemetry",
            module_id="sr1_homeostatic_core",
            micro_stages=(
                _stage(
                    "sr1.m1_state_registry",
                    "SR1.1 State registry",
                    mode="integrate",
                    module_targets=sr_forecast_module_targets,
                    objective_signals=("integration_quality", "stability", "safety"),
                    min_observations=64,
                ),
                _stage(
                    "sr1.m2_homeostasis_update_loop",
                    "SR1.2 Homeostasis update loop",
                    mode="integrate",
                    module_targets=sr_forecast_module_targets,
        ...
        AdaptivePhaseSpec(
            phase_id="phase_sr2_allostatic_forecasting",
            label="Phase SR2 - Allostatic Forecasting",
            capability="forecast short-horizon pressure using trend derivatives and apply preemptive soft correction",
            module_id="sr2_allostatic_forecasting",
            micro_stages=(
                _stage(
                    "sr2.m1_trend_derivatives",
                    "SR2.1 Trend derivatives",
                    mode="integrate",
                    module_targets=sr_forecast_module_targets,
        ...
        AdaptivePhaseSpec(
            phase_id="phase_sr3_controlled_actuation",
            label="Phase SR3 - Controlled Actuation",
            capability="enable exploration, effort, and safety strictness actuators one at a time with hard clamp rails",
            module_id="sr3_controlled_actuation",
            micro_stages=(
                _stage(
                    "sr3.m1_exploration_actuator",
                    "SR3.1 Exploration actuator",
                    mode="integrate",
                    module_targets=sr3_exploration_module_targets,
                    objective_signals=("integration_quality", "transfer", "safety"),
                    min_observations=96,
                ),
                _stage(
                    "sr3.m2_effort_actuator",
                    "SR3.2 Effort actuator",
                    mode="integrate",
                    module_targets=sr3_effort_module_targets,
                    objective_signals=("integration_quality", "stability", "safety"),
                    min_observations=108,
                ),
                _stage(
                    "sr3.m3_safety_strictness_actuator",
                    "SR3.3 Safety strictness actuator",
                    mode="control_integrate",
                    module_targets=sr3_safety_module_targets,
                    objective_signals=("integration_quality", "safety", "introspection_gain"),
        ...
        AdaptivePhaseSpec(
            phase_id="phase_sr4_bounded_plasticity",
            label="Phase SR4 - Bounded Plasticity",
            capability="re-enable target adaptation with health gates, gain governance, and anti-drift bounds",
            module_id="sr4_bounded_plasticity",
            micro_stages=(
                _stage(
                    "sr4.m1_target_adapt_reenable",
                    "SR4.1 Target adapt re-enable",
                    mode="integrate",
                    module_targets=sr4_plasticity_module_targets,
                    objective_signals=("integration_quality", "transfer", "stability"),
                    min_observations=104,
                ),
                _stage(
                    "sr4.m2_plasticity_gain_governor",
                    "SR4.2 Plasticity gain governor",
                    mode="control_integrate",
                    module_targets=sr4_plasticity_module_targets,
        ...
        AdaptivePhaseSpec(
            phase_id="phase_sr5_immune_safety_recovery",
            label="Phase SR5 - Immune Safety + Recovery",
            capability="trigger immune clamp and cooldown recovery loops when instability or override pressure spikes",
            module_id="sr5_immune_safety_recovery",
            micro_stages=(
                _stage(
                    "sr5.m1_immune_clamp",
                    "SR5.1 Immune clamp",
                    mode="control_integrate",
                    module_targets=sr5_immune_module_targets,
                    objective_signals=("integration_quality", "safety", "stability"),
                    min_observations=122,
                ),
                _stage(
                    "sr5.m2_recovery_cooldown",
                    "SR5.2 Recovery cooldown",
                    mode="control_integrate",
                    module_targets=sr5_immune_module_targets,
        ...
        AdaptivePhaseSpec(
            phase_id="phase_sr6_autonomous_governance",
            label="Phase SR6 - Autonomous Governance",
            capability="add meta-policy selection, self-tuning budgets, drift rollback, and bounded override challenge",
            module_id="sr6_autonomous_governance",
            micro_stages=(
                _stage(
                    "sr6.m1_meta_policy_selection",
                    "SR6.1 Meta-policy selection",
                    mode="control_integrate",
                    module_targets=sr6_governance_module_targets,
                    objective_signals=("integration_quality", "transfer", "safety"),
                    min_observations=132,
                ),
                _stage(
                    "sr6.m2_self_tuning_budget_controller",
                    "SR6.2 Self-tuning budget controller",
                    mode="control_integrate",
                    module_targets=sr6_governance_module_targets,
                    objective_signals=("integration_quality", "transfer", "stability"),
                ...
                _stage(
                    ...
                    "SR6.3 Long-horizon stability review",
                    mode="control_integrate",
                    module_targets=sr6_governance_module_targets,
                    objective_signals=("integration_quality", "stability", "safety"),
                ...
                _stage(
                    ...
                    "SR6.4 Bounded override challenge",
                    mode="control_integrate",
                    module_targets=sr6_governance_module_targets,
                    objective_signals=("integration_quality", "safety", "introspection_gain"),
