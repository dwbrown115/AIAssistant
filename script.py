import os, re
exclude_dirs = {'.venv', 'Log Dump', 'Log Dump OLD', 'kernel_runtime/Log Dump', 'AIAssistant-main', 'AIAssistantBAD', 'deprecated', '__pycache__'}
kernel_targets = ['kernel_runtime', 'runtime_kernel', 'maze', 'adaptive_controller.py', 'learned_autonomy_controller.py', 'organism_control.py', 'parallel_reasoning_engine.py', 'governance_orchestrator.py', 'kernel_contracts.py', 'runtime/app_runtime.py', 'app.py']
